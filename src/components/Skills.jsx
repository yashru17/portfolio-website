      ...
      <div className="lg:w-[65%] md:w-[65%] w-[90%] h-full flex flex-col justify-center items-center mt-44 gap-2">
        ...
        <div className="w-full flex flex-col gap-20 py-10">
          ...
          <div className="flex flex-col gap-8 ">
            <h1 className="text-orange-500 lg:text-3xl md:text-3xl text-xl tracking-wide exo-2-regular">
              WEB DEVELOPMENT
            </h1>
            <div className="flex justify-center flex-wrap  items-center lg:gap-14 md:gap-14 gap-6">
          ...
          {/* other */}
          <div className="flex flex-col gap-8 ">
            <h1 className="text-orange-500 lg:text-3xl md:text-3xl text-xl tracking-wide exo-2-regular">OTHER</h1>
            <div className="flex justify-center flex-wrap  items-center lg:gap-14 md:gap-14 gap-6">
